...
for index, thread in enumerate(threads):
    ...
    #thread che lavorano in parallelo fanno accesso alla stessa risorsa 
    #e la modificano, essendo i due thread uguali non so quale va per 
    #primo, quindi ci possono essere problemi, la risorsa dovrebb 
    #essere modificata da un Thread alla voltar